...
const SideBar = () => {
    ...
    const SessionItem = useCallback(({ index, style }) => {
        ...
        return (
            ...
            >
                ...
                <div className="entry-actions">
                    <img 
                        src={isDarkMode ? assets.more_vertical_dark : assets.more_vertical_light} 
                        alt="更多"
                        className="more-icon"
                        onClick={(e) => {
                            e.stopPropagation();
    ...
    }, [currentSessionId, renamingId, menuOpenId, isDarkMode, handleRenameSubmit, isStreaming]);
    ...
    return (
        <div className={`sidebar ${isExpanded ? '' : 'collapsed'}`}>
            <div className="top">
                <img className='menu' src={assets.menu_icon} alt="菜单" onClick={() => setIsExpanded(!isExpanded)} />
                <div 
                    onClick={() => {
                        if (!isStreaming) {
                            newChat();
